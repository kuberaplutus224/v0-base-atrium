...
export default function NextBestStep() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-secondary px-6 py-4 shadow-lg">
        ...
        <div className="flex flex-1 items-center gap-3">
          ...
          <p className="text-sm text-secondary-foreground">
            ...
            <button className="font-semibold text-accent transition-opacity hover:opacity-80">
              Would you like to Draft a Vendor Order?
            </button>
          </p>
        </div>
        <button
          onClick={() => setIsDismissed(true)}
          className="flex-shrink-0 text-secondary-foreground transition-opacity hover:opacity-60"
